...
BARAM의 FICR은 이 현실 제도의 문제의식을 대회용 평가 함수로 가져온 것입니다. P3 리서치 기준으로 대회 FICR의 6%/8%, 4원/3원/0원 구조는 개정 전 KPX 예측제도 구조와 유사합니다. 다만 실제 제도는 2025년 개정으로 기준이 4%/6%로 강화된 것으로 조사되었으므로, 발표에서는 "대회용 지표"와 "현행 제도"를 분리해 설명합니다. 최종 모델 최적화는 DACON 평가 코드 기준으로 수행합니다.
...
6. 정산단가 자체의 태양광/풍력 차등은 확인되지 않았고, 조사 기준 차등은 강화 기준 시행 시점 유예로 정리한다.
...
- IEA Wind Task 25: https://iea-wind.org
- NREL 풍력 예측 자료: https://docs.nrel.gov
- 해줌 제도 변경 공지: https://blog.haezoom.com/notice_05/
...
P3 제도 조사 원문: [P3-3 시장 및 제도 조사](research/2026-07-06-p3-3-market-policy.md)
